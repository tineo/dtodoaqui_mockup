				...
				<form action="resultado-busqueda.php" method="post"  class="geolocator-form">
				    <div class="main-search-input">
						<div class="main-search-input-item ui-widget">
    						<input id="palabcomplete" type="text" name="search" placeholder="¿Qué estás buscando?" value="" required />
						</div>
						...
						<div class="main-search-input-item">
							<select name="category" data-placeholder="Todas las categorías" class="chosen-select" required>
