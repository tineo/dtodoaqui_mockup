...
<!-- Basic Page Needs
================================================== -->
<title>D'TodoAqui | Mis Establecimientos</title>
			...
			<div class="col-lg-12 col-md-12">
				<div class="dashboard-list-box margin-top-0">
					<div style="padding: 20px;">
						<form id="establishment_form" class="form-horizontal my_est">
							<div class="form-group">
								<label class="col-md-2 col-sm-3 control-label" style="padding-top: 15px;">Filtrar:</label>
								<div class="col-md-10 col-sm-5">
									<input id="establishment_search" class="my_est" value="" type="text" placeholder="Escriba el nombre del establecimiento">
								</div>
							</div>
						</form>
					</div>
					...
					<div id="establishments_container" class="row visible-lg">
						...
						<div class="col-md-3 col-sm-6 col-xs-12 sinPadding establishment_card">
							...
							<div class="contEst">
								...
								<div style="clear: both;"></div>
								<div class="accion"><a href="editar_establecimientos.php"><i class="sl sl-icon-settings"></i> Editar establecimiento</a></div>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6 col-xs-12 sinPadding establishment_card">
							...
							<div class="contEst">
								...
								<div style="clear: both;"></div>
								<div class="accion"><a href="#"><i class="sl sl-icon-settings"></i> Editar establecimiento</a></div>
							</div>
						</div>
						<!--Fin DatosEstablecimiento-->
					    ...
					    <div class="row" style="display: flex; justify-content: space-between;">
    						...
    						<div class="col-md-3 col-sm-6 col-xs-12 sinPadding establishment_card" style="width: 45%;">
    							...
    							<div class="contEst">
    								...
    								<div style="clear: both;"></div>
    								<div class="accion"><a href="editar_establecimientos.php" style="font-size: 11px;"><i class="sl sl-icon-settings"></i> Editar establecimiento</a></div>
    							</div>
    						</div>
    						<!--Fin DatosEstablecimiento-->
    						...
    						<div class="col-md-3 col-sm-6 col-xs-12 sinPadding establishment_card" style="width: 45%;">
    							...
    							<div class="contEst">
    								...
    								<div style="clear: both;"></div>
    								<div class="accion"><a href="#" style="font-size: 11px;"><i class="sl sl-icon-settings"></i> Editar establecimiento</a></div>
    							</div>
    						</div>
    						<!--Fin DatosEstablecimiento-->
